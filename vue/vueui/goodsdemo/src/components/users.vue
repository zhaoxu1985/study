    ...
    <el-card class="box-card">
      ...
      >
        ...
        >
          <el-form-item
            ...
            prop="username"
          >
            <el-input v-model="addUsersFrom.username" />
          </el-form-item>
          <el-form-item
            label="密码"
            prop="password"
          ...
          <el-form-item
            ...
            prop="email"
          >
            <el-input v-model="addUsersFrom.email" />
          </el-form-item>
          <el-form-item
            label="手机"
            prop="mobile"
          >
            <el-input v-model="addUsersFrom.mobile" />
          </el-form-item>
        </el-form>
      ...
      >
        ...
        <span slot="footer">
          ...
          <el-button
            type="primary"
            @click="editUserInfo('editUserRefs')"
          >确 定</el-button>
        </span>
      </el-dialog>
      <!-- 分配角色卡片 -->
